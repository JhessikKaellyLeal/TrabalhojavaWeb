<%-- 
    ...
    Created on : 12 de dez de 2021, 09:35:40
    Author     : jhess
--%>
...
<html>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Cadastro de Produto <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="usuario.jsp">Cadastro Usuário</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="funcionario.jsp">Cadastro de Funcionarios</a>
                </li> 
    ...
    <!--Tabela Mostrar Funcionarios Cadastros -->
    <div class="container">
    ...
    Novo Funcionario
            ...
            <form class="form-inline my-2 my-lg-0 text-right direita" method="post">
                ...
                <button class="btn btn-outline-info btn-sm my-2 my-sm-0" type="submit" name="btn-buscar" ><i class="fas fa-search-plus"></i>Buscar</button>
            </form>
        </div>
...
<!-- Modal - Formulário para cadastro de funcionarios -->
...
<%    if (request.getParameter("btn-salvar") != null) {
        ...
        st = new Conexao().conectar().createStatement();
        try {
            st.executeUpdate("Insert into funcionario (nome,endereco,bairro,funcao,salario) "
...
<%    if (request.getParameter("btn-editar") != null) {
        ...
        try {
            ...
            st.executeUpdate("update funcionario set nome= '" + nome + "', endereco= '" + endereco + "',bairro='" + bairro + 
                    "',funcao='" + funcao + "',salario='" + salario +"'where id='" + id + "'");
            response.sendRedirect("funcionario.jsp");
        } catch (Exception e) {
        }
